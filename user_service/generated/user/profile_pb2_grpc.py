...
class UserProfileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetUserAvatar = channel.unary_unary(
                ...
                request_serializer=profile__pb2.SetUserAvatarRequest.SerializeToString,
                response_deserializer=profile__pb2.SetUserAvatarResponse.FromString,
                _registered_method=True)
        self.ListProfilesByIds = channel.unary_unary(
                '/user_profile.UserProfileService/ListProfilesByIds',
                request_serializer=profile__pb2.ListProfilesByIdsRequest.SerializeToString,
                response_deserializer=profile__pb2.ListProfilesByIdsResponse.FromString,
                _registered_method=True)
...
def add_UserProfileServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetUserAvatar': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=profile__pb2.SetUserAvatarRequest.FromString,
                    response_serializer=profile__pb2.SetUserAvatarResponse.SerializeToString,
            ),
            'ListProfilesByIds': grpc.unary_unary_rpc_method_handler(
                    servicer.ListProfilesByIds,
                    request_deserializer=profile__pb2.ListProfilesByIdsRequest.FromString,
                    response_serializer=profile__pb2.ListProfilesByIdsResponse.SerializeToString,
            ),
    }
...
class UserProfileService(object):
    ...
    def SetUserAvatar(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user_profile.UserProfileService/SetUserAvatar',
            profile__pb2.SetUserAvatarRequest.SerializeToString,
            profile__pb2.SetUserAvatarResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListProfilesByIds(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user_profile.UserProfileService/ListProfilesByIds',
            profile__pb2.ListProfilesByIdsRequest.SerializeToString,
            profile__pb2.ListProfilesByIdsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
